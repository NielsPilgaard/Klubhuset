...
# Course categories seeded by DbSeeder/CourseSeeder — names must match exactly
$courseNames = @("Dansk","Matematik","Engelsk","Naturfag","Historie","Musik","Idræt","Kristendomskundskab","Billedkunst","Håndværk og design","Tysk","Fransk","Geografi","Biologi","Fysik/kemi","Samfundsfag")
...
$template = Invoke-Api -Method PUT -Path "/api/v1/time-slot-template" -Body $templateBody
