...
export default function NotificationBell({ variant = 'light' }: NotificationBellProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 max-w-[calc(100vw-2rem)] bg-white rounded-lg shadow-lg border border-gray-200 z-50 flex flex-col max-h-[min(70vh,28rem)]">
          {/* Header */}
