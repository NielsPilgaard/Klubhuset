...
export default function ParentCalendarPage() {
  ...
  const entriesStart: CalendarEntryDto[] = Array.isArray(rawStart) ? (rawStart as CalendarEntryDto[]) : []
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center justify-between gap-4">
        <h1 className="text-xl font-semibold text-gray-900">Kalender {startYear}/{endYear}</h1>
        <select
